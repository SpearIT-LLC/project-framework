...
├── project-hello-world/    # References ../framework/
...
**Exclude candidates:**
- `framework/thoughts/` - Framework's own work items
- `framework/thoughts/history/` - Framework's history
...
**Recommendation:** Exclude `framework/thoughts/` (project-specific to framework development)
