...
No external reference template exists. The `thoughts/external-references/README.md` explains what to store but not how to format references.
...
- `thoughts/external-references/README.md` explains purpose
...
**Files Updated:**
- `thoughts/external-references/README.md` - Add link to template and naming convention
