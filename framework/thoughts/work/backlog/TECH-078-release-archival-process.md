...
Document that work items in `done/` must be archived to `thoughts/history/releases/vX.Y.Z/` immediately after each release. Current release process doesn't enforce this step.
