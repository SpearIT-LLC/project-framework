...
#### Current Status
- [PROJECT-STATUS.md](PROJECT-STATUS.md) - **Single source of truth** for version and status
...
- [README.md](templates/standard/README.md) - Template README
- [PROJECT-STATUS.md](templates/standard/PROJECT-STATUS.md) - Template status
- [CHANGELOG.md](templates/standard/CHANGELOG.md) - Template changelog
- [INDEX.md](templates/standard/INDEX.md) - Template index
...
- **Git clone:** Available now (clone repository)
- **Setup script:** *(planned)* Interactive setup wizard

### Tooling
- **Validation script:** *(planned)* Verify framework structure
- **Upgrade script:** *(planned)* Automated level upgrades
- **Stale doc checker:** *(planned)* Find outdated documentation
...
### Related Projects
- **HPC Job Queue Prototype:** Original project that birthed this framework
- **Future projects using framework:** *(to be listed)*
...
1. Update [PROJECT-STATUS.md](PROJECT-STATUS.md) for status changes
2. Update [CHANGELOG.md](CHANGELOG.md) for releases
3. Keep this index current as docs evolve

---

## Document Categories Legend

- 📘 **User Documentation** - For people using the framework
- 🔧 **Developer Documentation** - For framework developers/contributors
- 📋 **Templates** - Reusable templates in the framework package
- 📊 **Status & Tracking** - Project status and work tracking
- 🎯 **Planning** - Roadmaps and future work
- 📚 **Reference** - Standards, patterns, processes

---

**Questions?**
- Review [README.md](README.md) for project overview
- Check [PROJECT-STATUS.md](PROJECT-STATUS.md) for current version
