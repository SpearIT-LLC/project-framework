...
## Broad Categories
These categories could enhance or replace existing categories for the framework project.

- Workflow
  - How tickets move through the system.
  - (Should Release be included here or does it deserve it's own category?)
- Release
  - Process to release
  - Distribution
- Project Planning.
