...
1. **ADR-001: AI Workflow Checkpoint Policy**
   ...
   - **Location:** `project-hub/project/research/adr/001-ai-workflow-checkpoint-policy.md`
...
- [kanban-workflow.md](../../project-framework-template/standard/project-hub/framework/process/kanban-workflow.md) - Process we violated
