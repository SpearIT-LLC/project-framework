...
**Impact:** Minor
**Scope:** project-hub/ folder structure, developer.prototype workflow
**Supersedes:** None
...
1. **Option A: `project-hub/work/poc/`** - POC as part of work folders
   - Pros: Part of work tracking, visible in workflow
   - Cons: POCs don't follow kanban flow (backlog→todo→doing→done)

2. **Option B: `project-hub/poc/`** - POC as sibling to work/
...
4. **Option D: `project-hub/research/poc/`** - POC as part of research
...
We chose **Option B: `project-hub/poc/`** because:
...
4. If yes → create spike folder in `project-hub/poc/SPIKE-XXX-description/`
...
**During spike:** All artifacts live in `project-hub/poc/SPIKE-XXX/`
