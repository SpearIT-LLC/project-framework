# /fw-swarm - AI Facilitated Project Kick-off
...
```
/fw-swarm              # Full team discussion
/fw-swarm --summary    # Bottom-line only, no team discussion
```
...
**Created:** YYYY-MM-DD (via /fw-swarm)
...
---
*Generated by /fw-swarm on YYYY-MM-DD. Update when project direction changes significantly.*
```
...
---
*Generated by /fw-swarm on YYYY-MM-DD. Update as phases complete and project evolves.*
```
...
---
*AI-generated meeting record via /fw-swarm*
```
...
**User runs `/fw-swarm` mid-project:**
...
📋 Next steps:
   ...
   - Create work items with /fw-new
   - Run /fw-roadmap when ready to define planning periods
```
