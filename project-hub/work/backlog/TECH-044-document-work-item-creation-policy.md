...
Add explicit policy to workflow-guide.md stating that all new work items must be created in `project-hub/work/backlog/` with Status: Backlog, and only move to todo/ when committed to work on soon.
...
**Rule:** All new work items MUST be created in `project-hub/work/backlog/` with `Status: Backlog`.

**Process:**
1. Create new work item file in `project-hub/work/backlog/`
...
1. Create file in `project-hub/work/backlog/`
