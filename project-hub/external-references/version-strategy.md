...
- v2.0.0 → v3.0.0: Complete restructure of project-hub/ folder (hypothetical)
...
1. **Work completed** in project-hub/project/work/doing/
...
7. **Move work items** to project-hub/project/work/done/
8. **Archive to** project-hub/project/history/releases/vX.Y.Z/
