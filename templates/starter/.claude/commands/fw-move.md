...
1. **Find the item**: Search `framework/project-hub/work/` subfolders for a file matching the item-id
...
|------|----|----|--------|
| backlog | todo | Yes | Standard flow - committing to work |
| backlog | doing | No | Must commit to work (todo) first |
| todo | doing | Yes | Starting work |
| todo | backlog | Yes | Deprioritizing work |
| doing | done | Yes | Completing work |
| doing | todo | Yes | Pausing work |
| done | history | Yes | Post-release archival |
| done | backlog | No | No reopening - create a new work item instead |
| done | todo | No | No reopening - create a new work item instead |
| done | doing | No | No reopening - create a new work item instead |
...
- to doing triggers pre-implementation review
- to done triggers session history update and commit
- to releases triggers full release process
