...
2. Scan `framework/project-hub/work/` subfolders and count items
...
- **Work items**: `framework/project-hub/work/{backlog,todo,doing,done}/`
- **WIP limit**: `framework/project-hub/work/doing/.limit` (default: 2)
...
- **Items in done/**: Flag as ready for release
